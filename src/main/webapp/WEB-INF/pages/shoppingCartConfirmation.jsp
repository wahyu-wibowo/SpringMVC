...
<body>
  ...
  <div class="customer-info-container">
      ...
      <ul>
      	  <li>ID: ${myCart.customerInfo.customerId}</li>
          ...
          <li>Type: ${myCart.customerInfo.type}</li>
          <li>Join Date: ${myCart.customerInfo.joinDate}</li>
      </ul>
      <h3>Cart Summary:</h3>
      <ul>
          ...
          <li>Discount:
          <span class="discount">
            <fmt:formatNumber value="${myCart.discount}" type="currency"/>
          </span></li>
      </ul>
  </div>
